...
async function migrate() {
  try {
    console.log("Creating author_profile table...");
    await sql`
    ...
    `;
    console.log("✓ author_profile table created");

    console.log("Creating author_skill table...");
    await sql`
    ...
    `;
    console.log("✓ author_skill table created");
    ...
    `;
    console.log("✓ author_experience table created");

    console.log("Creating author_education table...");
    await sql`
    ...
    `;
    console.log("✓ author_education table created");

    console.log("Creating author_honor table...");
    await sql`
    ...
    `;
    console.log("✓ author_honor table created");

    console.log("\n✓ All author tables created successfully!");
  } catch (error) {
