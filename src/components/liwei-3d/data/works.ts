...
export const SECTION_COVERS: Record<string, string> = {
  ad: `${LIWEI_ASSET_BASE}works/covers/ad.jpg`,
  maker: `${LIWEI_ASSET_BASE}works/covers/maker.jpg`,
  product: `${LIWEI_ASSET_BASE}works/covers/product.jpg`,
  graphics: `${LIWEI_ASSET_BASE}works/covers/graphics.jpg`,
}
